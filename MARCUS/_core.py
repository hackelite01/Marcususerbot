...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "MarcusUserbot"
    ...
    if event.reply_to_msg_id:
        try:
            ...
            if "(" not in downloaded_file_name:
                ...
                await eor(
                    event,
                    "**Error!**\nPlugin cannot be installed Master!\n Or may have been pre-installed Master. If You Find Any Error Then Go To [Support Group](t.me/hackelitebotsupport) Master",
                )
