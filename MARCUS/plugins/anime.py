...
async def _(event):
    ...
    msg_str = msg_str.replace("']","")
    msg_str = msg_str.replace("' '","")
    msg_str_front = "Here's Top "+str(number_of_times)+" Action Anime List For you Master!\n"
...
async def action(event):
    ...
    msg_str = msg_str.replace("']","")
    msg_str = msg_str.replace("' '","")
    msg_str_front = "Here's Top "+str(number_of_times)+" Master Anime List For you !\n"
    msg_str = msg_str_front+ msg_str
    msg_str = msg_str.replace("\\n","\n")
    msg_str = msg_str.replace("'","")
    msg_str = msg_str.replace('"',"")
