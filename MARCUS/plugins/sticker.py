...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "No Name Set Yet, Check @hackelitebotlist"
...
async def _(event):
    ...
    file_ext_ns_ion = "@hackelitebotlist_Sticker.png"
    ...
    if is_a_s:
        ...
        if userid == 997887920:
            packshortname = "@hackelitebotlist_animated"
        else:
