...
async def _(event):
    ...
    try:
        ...
        await event.edit("Succesfully changed master's profile bio! Check ☑Now Master!© @hackelitebotlist")
...
async def _(event):
    ...
    try:
        ...
        await event.edit("My Master Name was changed successfully! © @hackelitebotlist")
    except Exception as e:  # pylint:disable=C0103,W0703
        await event.edit(str(e))
    ...
    try:
        ...
        if photo:
            ...
            try:
                ...
                await event.edit("Master's profile picture was succesfully changed! Check Now Master! © @hackelitebotlist")
    try:
        os.remove(photo)
    except Exception as e:  # pylint:disable=C0103,W0703
