...
OFFICIAL_UPSTREAM_REPO = "https://github.com/hackelite01/Marcususerbot"
BOT_IS_UP_TO_DATE = "`The userbot is up-to-date.\nThank you for Using this Service.`"
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating Now plz wait"
)
NEW_UP_DATE_FOUND = (
    "New update found for {branch_name}\n"
    "`updating Now plz wait`"
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit("Updating and Deploying New Branch Master!!;Please wait for 5 minutes then use `.alive` to check if i'm working or not Master!If Not Go To [Support Group](t.me/hackelitebotlist)")
