...
pm_caption += "𝚂𝚃𝙰𝚃𝚄𝚂\n"
pm_caption += "ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀ. : (1.16.04)\n"
pm_caption += "ᴘʏᴛʜᴏɴ : (3.8.3)\n"
pm_caption += "ᴹᵃʳᶜᵘˢ :  **1.0.01** [Ask Support Group Master](t.me/hackelitebotlist)\n"
pm_caption += "ᴰᵃᵗᵃᵇᵃˢᵉ status : All Fine\n"
pm_caption += f"My Pro Master : {DEFAULTUSER}\n\n"
pm_caption += "Deploy Me Now (https://github.com/hackelite01/Marcususerbot.git)\n\n"
pm_caption +="ᴜᴘᴛɪᴍᴇ  :** `{uptime}'\n"
