...
if ENV:
    ...
    class Config(object):
        ...
        # Send .get_id in any channel to fill this value. ReQuired for @Godhackerzuserbot inspiration to work!
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Marcus-Telegraph")
